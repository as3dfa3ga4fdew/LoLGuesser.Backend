...
namespace UnitTests
{
    public class DDragonCdnClientTests
    {
        [Theory]
        [InlineData("13.20.1")]
        public async Task GetDataAsync_WhenValidVersionAndCdnCallSucceeds_ShouldReturnRootObject(string version)
        {
            //Arrange
            ...
            //Act
            Root result = await dDragonCdnClient.GetDataAsync(version);
        ...
        [Theory]
        [InlineData("13.20.1")]
        public async Task GetDataAsync_WhenException_ShouldReturnNull(string version)
        {
            // Arrange
            var handlerMock = new Mock<HttpMessageHandler>();
            handlerMock
        ...
        [Theory]
        [InlineData("error")]
        public async Task GetDataAsync_WhenInvalidVersion_ShouldReturnNull(string version)
        {
            // Arrange
            var handlerMock = new Mock<HttpMessageHandler>();
            handlerMock
        ...
        [Theory]
        [InlineData("13.20.1")]
        public async Task GetDataAsync_WhenResponseCannotBeDeserialized_ShouldReturnNull(string version)
        {
            //Arrange
            var handlerMock = new Mock<HttpMessageHandler>();
            var response = new HttpResponseMessage
        ...
        [Fact]
        public async Task GetVersionsAsync_WhenApiCallSucceeds_ShouldReturnAListOfStrings()
        {
            //Arrange
            var handlerMock = new Mock<HttpMessageHandler>();
            var response = new HttpResponseMessage
        ...
        [Fact]
        public async Task GetVersionsAsync_WhenException_ShouldReturnNull()
        {
            //Arrange
            var handlerMock = new Mock<HttpMessageHandler>();
            handlerMock
